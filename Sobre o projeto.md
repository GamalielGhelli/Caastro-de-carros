...
O objetivo deste projeto é colacar em prática aquilo que tem sido aprendido entro do curos de PHP e Laravel dos seguintes canais no [Youtube:]
...
Por padrão o **DB_CONNECTION** vem com **sqlite** no lugar de **mysql**, além disto em **SESSION_DRIVER** está **database** nolugar de **file**, então é somente você fazer essa troca que a conexão com o DB
estará funcionando, além de excluir todo os "#" para ativar. 
